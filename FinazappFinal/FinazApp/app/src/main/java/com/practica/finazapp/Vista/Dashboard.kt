...
class Dashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(
            R.id.nav_dashboard, R.id.nav_perfil, R.id.nav_tips, R.id.nav_ingresos, R.id.nav_reporte , R.id.graficos_Avanzados, R.id.gastosAltos, R.id.fragmentAlertas, R.id.fragmentProyecciones
        ), drawerLayout
        )
